    ...
    >
      <div>
        ...
        <p class="mt-4 text-gray-700">
          ...
          care, manicures and pedicures, eyelash extensions, eyebrows,permament
          makeup, microblading and shading. We strive to meet the needs of each
          client, and our team works hard to provide high- quality service and
      ...
      <div
        class="absolute inset-x-0 -top-100 -z-10 transform-gpu overflow-hidden blur-3xl sm:-top-100"
        aria-hidden="true"
      >
        <div
          class="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#ff80b5] to-[#9089fc] opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
  ...
  meta: [
    {
      ...
      content: 'jl11mty3hxrk99sbnray4d3r9g6kyu',
    },
  ],
})
</script>
