<template>
  <div class="bg-white">
    ...
    <footer class="bg-white rounded-lg shadow dark:bg-gray m-4">
      <div class="w-full max-w-screen-xl mx-auto p-4 md:py-8">
        ...
        <span class="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 UNIQUE YOU™. All Rights Reserved.</span>
      </div>
    </footer>
